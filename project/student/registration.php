    ...
    <div class="login_wrapper">
            ...
            <section class="login_content" style="margin-top: -40px;">
                <form name="form1" action="" method="post">
                    ...
                    <div>
                        <input type="text" class="form-control" placeholder="FirstName" name="name" required=""/>
                    </div>
                    ...
                    <div>
                        <input type="text" class="form-control" placeholder="Enrollment No" name="eno" required=""/>
                    </div>
                    <div class="col-lg-12  col-lg-push-3">
                        <input class="btn btn-default submit " type="submit" name="sub" value="Register">
                    </div>
